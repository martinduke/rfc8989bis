---
title: "Nomcom Eligibility"
abbrev: rfc8989bis
docname: draft-duke-elegy-rfc8989bis
category: bcp
...
having a no-fee remote option ({{?I-D.draft-kuehlewind-shmoo-remote-fee}}), the
...
Finally, it is historically difficult recruit volunteers for NomCom, so overly
restrictive criteria work against getting a deep talent pool.
...
while others might now find such an attack to be feasible.
